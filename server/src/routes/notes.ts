...
router.get('/activity/all', authenticateToken as any, getAllActivityLogs as any);
...
router.post('/:noteUUID/collaborators', authenticateToken as any, manageCollaborators as any);
